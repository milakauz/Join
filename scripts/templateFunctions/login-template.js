/**
 * Generating HTML template for the "Forgot Password" page.
 *
 * @returns {string} The HTML string representing the "Forgot Password" template.
 */
function templateForgotPassword() {
  return `
          ...
          <form onsubmit="sendPasswordMail(event);">
              ...
              <input class="text-input" type="email" id="forgotPasswordInput" name="email" id="email" placeholder="Email" required/>
...
/**
 * Generating HTML template for the login page.
 *
 * @returns {string} The HTML string of the login template.
 */
function templateSignUp() {
  return `
      ...
      <span class="login-line"></span>
      <div class="input-container">
          <input class="text-input" type="text" name="name" id="name" placeholder="Name" required/>
          <img src="./img/person.svg" alt="Small Person Symbol" class="input-icons"/>
      </div>
      <div class="input-container">
        <input class="text-input" type="email" name="email" id="email" placeholder="Email" required/>
        <img src="./img/mail.svg" alt="Small Mail Symbol" class="input-icons"/>
      ...
      <div class="input-container">
        <input class="text-input" type="password" name="confirmPassword" placeholder="Confirm Password" id="confirmPassword" required/>
        <img src="./img/lock.svg" alt="Small Lock Symbol" class="input-icons"/>
      </div>
      <div class="checkbox-container">
      <div class="remember-me-container">
        <input class="remember-checkbox" required type="checkbox" name="remember" id="remember"/>
